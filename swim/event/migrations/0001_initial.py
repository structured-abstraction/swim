    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ownlink', models.ForeignKey(related_name='calendar_set', blank=True, editable=False, to='content.Link', null=True, on_delete=models.CASCADE)),
                ('resource_type', models.ForeignKey(related_name='calendar_set', blank=True, to='core.ResourceType', null=True, on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ('path',),
            },
            bases=(swim.event.models.HasTimeline, models.Model, swim.core.models.ClassIsContentType),
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('facebook_image', swim.media.fields.ImageField(help_text='\n<p><b>Facebook Image</b>: Set an image to use when this document is shared on Facebook.</p>\n', max_length=512, null=True, upload_to='content/facebook/', blank=True)),
                ('title', models.CharField(max_length=200)),
                ('name', models.SlugField(max_length=200, blank=True, help_text='This will automatically be set from the title.', null=True, verbose_name='Path Atom')),
                ('calendar', models.ForeignKey(related_name='event_set', to='event.Calendar', on_delete=models.CASCADE)),
                ('ownlink', models.ForeignKey(related_name='event_set', blank=True, editable=False, to='content.Link', null=True, on_delete=models.CASCADE)),
                ('resource_type', models.ForeignKey(related_name='event_set', blank=True, to='core.ResourceType', null=True, on_delete=models.CASCADE)),
            ],
            bases=(models.Model, swim.core.models.ClassIsContentType),
        ),
        migrations.AlterUniqueTogether(
            name='event',
            unique_together=set([('name', 'calendar'), ('title', 'calendar', 'start_date')]),
        ),
    ]
